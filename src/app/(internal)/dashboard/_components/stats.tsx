  ...
  return (
    <div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground">
                Connect your Google account and set your scheduling preferences
                to start tracking your meetings.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mb-8">
        <Card className="relative overflow-hidden border-none bg-card/40 backdrop-blur-md hover:bg-card/60 transition-all duration-500 group border border-border/5 shadow-sm">
          ...
          <CardContent>
            <div className="flex items-baseline">
              <div className="text-4xl font-tech font-bold tracking-tighter">
                {todayMeetings}
              </div>
            </div>
        ...
        <Card className="relative overflow-hidden border-none bg-card/40 backdrop-blur-md hover:bg-card/60 transition-all duration-500 group border border-border/5 shadow-sm">
          ...
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div
              className={`h-10 w-10 rounded-xl flex items-center justify-center border transition-transform duration-500 group-hover:scale-110 ${
