  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        <div className="relative rounded-3xl border border-border bg-card/80 dark:bg-gradient-to-br dark:from-primary/10 dark:via-black dark:to-accent/10 p-12 md:p-16 overflow-hidden backdrop-blur-sm">
